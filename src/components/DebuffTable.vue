<template>
    <el-table :data="tableData" style="width: 100%">
            ...
            <template #default="{ row }">
                <div class="flex items-center gap-1">
                    ...
                    <el-tooltip :content="row.description || '無說明'" placement="top">
                        <el-icon size="18">
                            <InfoFilled />
                            <!-- 這裡用的是 Element Plus 的 info icon -->
                        </el-icon>
                    </el-tooltip>
                </div>
            </template>
        ...
        <el-table-column prop="physicalDefense" label="物理防禦" width="200">
            <template #default="{ row }">
                <el-input-number
                    v-model="row.physicalDefense.value"
                    :min="0"
                    size="small"
        ...
        <el-table-column prop="physicalProtect" label="物理保護" width="200">
            <template #default="{ row }">
                <el-input-number
                    v-model="row.physicalProtect.value"
                    :min="0"
                    size="small"
        ...
        <el-table-column prop="magicalDefense" label="魔法防禦" width="200">
            <template #default="{ row }">
                <el-input-number
                    v-model="row.magicalDefense.value"
                    :min="0"
                    size="small"
        ...
        <el-table-column prop="magicalProtect" label="魔法保護" width="200">
            <template #default="{ row }">
                <el-input-number
                    v-model="row.magicalProtect.value"
                    :min="0"
                    size="small"
...
const tableData = ref<Debuff[]>([...debuffData]);
