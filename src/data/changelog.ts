...
export const announcements: Announcement[] = [
    { date: "2026-09-13", type: "new", text: "新增 治癒計算機：計算治癒的手／派對治癒（救贖回聲）效果，涵蓋稱號、武器、賦予、細工、聖水等全部加成欄位，並提供提升效益分析、全部最頂快速配置與紀錄保存/讀取功能" },
    { date: "2026-09-13", type: "fix", text: "修正 稱號查詢 搜尋能力（如治癒效果）時因資料 ID 未正規化而找不到結果的問題" },
    { date: "2026-09-13", type: "fix", text: "修正 裝備改造模擬器 治癒杖快速配置「治癒優先」實際套用成隊伍治癒效果的問題，並拆分為「治癒優先」與「組隊治癒優先」兩個配置" },
