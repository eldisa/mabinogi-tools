        ...
        "combos": [
            {
                ...
                "points": {
                    "5": "雷霆重擊: 雷神\n\n雷霆重擊 傷害倍率 400% 增加\n可攻擊距離 12m\n雷霆重擊 指定的敵人 7次攻擊\n雷霆重擊 使用時 4秒 持續 [雷神] 狀態獲得\n[雷神] 狀態下 重擊 使用時 重擊 傷害倍率 200% 增加, [雷神] 狀態 結束\n\n元素注入 使用中時 追加效果發動\n追加效果 : 追加傷害 600%,\n以冰霜風車 冰結的 對敵人 1680% 追加傷害\n冷卻時間 10秒",
            ...
            },
            {
                ...
                "points": {
                    "5": "爆炎跳斬: 完全燃燒\n\n使用者的倒地攻擊 傷害 + 技能 傷害 攻擊\n可攻擊距離 : 使用者的倒地攻擊 距離 +1.2m\n爆炎跳斬 攻擊 半徑 +1.5m\n\n[燃燒], [完全燃燒] 狀態 全部 沒有時 時 爆炎跳斬 使用時 [燃燒] 狀態獲得\n\n[燃燒] 狀態下 近距離 前투 才能/魔法 才能/爆炎跳斬 除外 元素 騎士 技能 攻擊 時, [完全燃燒] 狀態 最大 5層直到 獲得\n\n[完全燃燒] 層 持有 中 爆炎跳斬 使用時 爆炎跳斬으로 目前 打擊한 敵人的數相當於 最大 5層直到 追加 轉換並, 最大 層일 情況 [燃燒]的持續時間 5秒 延長\n[燃燒]的持續時間 20秒 秒할 數 無\n[完全燃燒] 層 每 100%的追加傷害 倍率\n\n元素注入 使用中時 追加效果發動\n追加效果 : 追加傷害 800%, 攻擊 目標 5秒 移動速度 20%, 攻擊 速度 20% 減少, 受擊的 敵人 目標 到位置 牽引김\n\n冷卻時間 1秒 減少",
                    "6": "爆炎跳斬: 完全燃燒\n\n使用者的倒地攻擊 傷害 + 技能 傷害 攻擊\n可攻擊距離 : 使用者的倒地攻擊 距離 +1.2m\n爆炎跳斬 攻擊 半徑 +2m\n\n[燃燒], [完全燃燒] 狀態 全部 沒有時 時 爆炎跳斬 使用時 [燃燒] 狀態獲得\n\n[燃燒] 狀態下 近距離 前투 才能/魔法 才能/爆炎跳斬 除外 元素 騎士 技能 攻擊 時, [完全燃燒] 狀態 最大 5層直到 獲得\n\n[完全燃燒] 層 持有 中 爆炎跳斬 使用時 爆炎跳斬으로 目前 打擊한 敵人的數相當於 最大 5層直到 追加 轉換並, 最大 層일 情況 [燃燒]的持續時間 5秒 延長\n[燃燒]的持續時間 20秒 秒할 數 無\n[完全燃燒] 層 每 100%的追加傷害 倍率\n\n元素注入 使用中時 追加效果發動\n追加效果 : 追加傷害 800%, 攻擊 目標 5秒 移動速度 20%, 攻擊 速度 20% 減少, 受擊的 敵人 目標 到位置 牽引김\n\n冷卻時間 1秒 減少",
                    "7": "爆炎跳斬: 完全燃燒\n\n使用者的倒地攻擊 傷害 + 技能 傷害 攻擊\n可攻擊距離 : 使用者的倒地攻擊 距離 +1.2m\n爆炎跳斬 攻擊 半徑 +2.5m\n\n[燃燒], [完全燃燒] 狀態 全部 沒有時 時 爆炎跳斬 使用時 [燃燒] 狀態獲得\n\n[燃燒] 狀態下 近距離 前투 才能/魔法 才能/爆炎跳斬 除外 元素 騎士 技能 攻擊 時, [完全燃燒] 狀態 最大 5層直到 獲得\n\n[完全燃燒] 層 持有 中 爆炎跳斬 使用時 爆炎跳斬으로 目前 打擊한 敵人的數相當於 最大 5層直到 追加 轉換並, 最大 層일 情況 [燃燒]的持續時間 5秒 延長\n[燃燒]的持續時間 20秒 秒할 數 無\n[完全燃燒] 層 每 100%的追加傷害 倍率\n\n元素注入 使用中時 追加效果發動\n追加效果 : 追加傷害 800%, 攻擊 目標 5秒 移動速度 20%, 攻擊 速度 20% 減少, 受擊的 敵人 目標 到位置 牽引김\n\n冷卻時間 1秒 減少",
                    "8": "爆炎跳斬: 完全燃燒\n\n使用者的倒地攻擊 傷害 + 技能 傷害 攻擊\n可攻擊距離 : 使用者的倒地攻擊 距離 +1.2m\n爆炎跳斬 攻擊 半徑 +3m\n\n[燃燒], [完全燃燒] 狀態 全部 沒有時 時 爆炎跳斬 使用時 [燃燒] 狀態獲得\n\n[燃燒] 狀態下 近距離 前투 才能/魔法 才能/爆炎跳斬 除外 元素 騎士 技能 攻擊 時, [完全燃燒] 狀態 最大 5層直到 獲得\n\n[完全燃燒] 層 持有 中 爆炎跳斬 使用時 爆炎跳斬으로 目前 打擊한 敵人的數相當於 最大 5層直到 追加 轉換並, 最大 層일 情況 [燃燒]的持續時間 5秒 延長\n[燃燒]的持續時間 20秒 秒할 數 無\n[完全燃燒] 層 每 100%的追加傷害 倍率\n\n元素注入 使用中時 追加效果發動\n追加效果 : 追加傷害 800%, 攻擊 目標 5秒 移動速度 20%, 攻擊 速度 20% 減少, 受擊的 敵人 目標 到位置 牽引김\n\n冷卻時間 1秒 減少",
    ...
    },
    {
        ...
        "combos": [
            ...
            },
            {
                ...
                "points": {
                    "5": "水流箭: 激流\n\n水流箭 차징 無法\n使用者的麥格農射擊 傷害 + 原有 水流箭 最大 傷害倍率的7% 攻擊\n\n[流動], [激流] 狀態 全部 持有並 있지 않을 時 水流箭 使用時 [流動] 獲得\n\n[流動] 狀態下 麥格農射擊 使用時 [激流] 狀態 最大 3層直到 獲得\n\n[激流] 層 持有 中 水流箭 使用時 層 全部 消耗並, 層 每 2次的追加 攻擊 發生\n\n冷卻時間 10秒",
                    "6": "水流箭: 激流\n\n水流箭 차징 無法\n使用者的麥格農射擊 傷害 + 原有 水流箭 最大 傷害倍率的9% 攻擊\n\n[流動], [激流] 狀態 全部 持有並 있지 않을 時 水流箭 使用時 [流動] 獲得\n\n[流動] 狀態下 麥格農射擊 使用時 [激流] 狀態 最大 3層直到 獲得\n\n[激流] 層 持有 中 水流箭 使用時 層 全部 消耗並, 層 每 2次的追加 攻擊 發生\n\n冷卻時間 10秒",
                    "7": "水流箭: 激流\n\n水流箭 차징 無法\n使用者的麥格農射擊 傷害 + 原有 水流箭 最大 傷害倍率的11% 攻擊\n\n[流動], [激流] 狀態 全部 持有並 있지 않을 時 水流箭 使用時 [流動] 獲得\n\n[流動] 狀態下 麥格農射擊 使用時 [激流] 狀態 最大 3層直到 獲得\n\n[激流] 層 持有 中 水流箭 使用時 層 全部 消耗並, 層 每 2次的追加 攻擊 發生\n\n冷卻時間 10秒",
                    "8": "水流箭: 激流\n\n水流箭 차징 無法\n使用者的麥格農射擊 傷害 + 原有 水流箭 最大 傷害倍率的13% 攻擊\n\n[流動], [激流] 狀態 全部 持有並 있지 않을 時 水流箭 使用時 [流動] 獲得\n\n[流動] 狀態下 麥格農射擊 使用時 [激流] 狀態 最大 3層直到 獲得\n\n[激流] 層 持有 中 水流箭 使用時 層 全部 消耗並, 層 每 2次的追加 攻擊 發生\n\n冷卻時間 10秒",
        ...
        "combos": [
            {
                ...
                "points": {
                    "5": "烈風穿刺: 突進\n\n烈風穿刺 使用時 目標한 敵人 방향으로 5m 突進 後, 原有 烈風穿刺 傷害的100% 攻擊\n\n烈風穿刺 使用 後 5秒 內 연속기 3階段 技能 使用時, 原有 傷害的104% 敵人 攻擊\n\n力量 消耗量 1個\n\n自身게 狂怒 絕對 10秒 期間 套用\n(一定 數준 以下的重型 標準 者동 防禦 무時並, 拳套 武器 使用以 攻擊 造成的 技能的傷害量 15% 增加 效果 賦予 (狂暴 衝擊 效果 疊加 無法))",
                    "6": "烈風穿刺: 突進\n\n烈風穿刺 使用時 目標한 敵人 방향으로 5m 突進 後, 原有 烈風穿刺 傷害的105% 攻擊\n\n烈風穿刺 使用 後 5秒 內 연속기 3階段 技能 使用時, 原有 傷害的106% 敵人 攻擊\n\n力量 消耗量 1個\n\n自身게 狂怒 絕對 10秒 期間 套用\n(一定 數준 以下的重型 標準 者동 防禦 무時並, 拳套 武器 使用以 攻擊 造成的 技能的傷害量 15% 增加 效果 賦予 (狂暴 衝擊 效果 疊加 無法))",
                    "7": "烈風穿刺: 突進\n\n烈風穿刺 使用時 目標한 敵人 방향으로 5m 突進 後, 原有 烈風穿刺 傷害的110% 攻擊\n\n烈風穿刺 使用 後 5秒 內 연속기 3階段 技能 使用時, 原有 傷害的108% 敵人 攻擊\n\n力量 消耗量 1個\n\n自身게 狂怒 絕對 10秒 期間 套用\n(一定 數준 以下的重型 標準 者동 防禦 무時並, 拳套 武器 使用以 攻擊 造成的 技能的傷害量 15% 增加 效果 賦予 (狂暴 衝擊 效果 疊加 無法))",
                    "8": "烈風穿刺: 突進\n\n烈風穿刺 使用時 目標한 敵人 방향으로 5m 突進 後, 原有 烈風穿刺 傷害的115% 攻擊\n\n烈風穿刺 使用 後 5秒 內 연속기 3階段 技能 使用時, 原有 傷害的110% 敵人 攻擊\n\n力量 消耗量 1個\n\n自身게 狂怒 絕對 10秒 期間 套用\n(一定 數준 以下的重型 標準 者동 防禦 무時並, 拳套 武器 使用以 攻擊 造成的 技能的傷害量 15% 增加 效果 賦予 (狂暴 衝擊 效果 疊加 無法))",
