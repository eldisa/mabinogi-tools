...
export const oghamArcanas: OghamArcana[] = [
        ...
        "combos": [
            {
                ...
                "points": {
                    "5": "閃電重擊: 雷神\n\n閃電重擊 傷害倍率 400% 增加\n可攻擊距離 12m\n閃電重擊 指定的敵人 7次攻擊\n閃電重擊 使用時 4秒 持續 [雷神] 狀態獲得\n[雷神] 狀態下 重擊 使用時 重擊 傷害倍率 200% 增加, [雷神] 狀態 종료\n\n元素注入 使用中時 追加效果發動\n追加效果 : 追加傷害 600%,\n以冰風車 冰結的 對敵人 1680% 追加傷害\n冷卻時間 10秒",
                    "6": "閃電重擊: 雷神\n\n閃電重擊 傷害倍率 700% 增加\n可攻擊距離 12m\n閃電重擊 指定的敵人 7次攻擊\n閃電重擊 使用時 4秒 持續 [雷神] 狀態獲得\n[雷神] 狀態下 重擊 使用時重擊 傷害倍率 250% 增加, [雷神] 狀態 종료\n\n元素注入 使用中時 追加效果發動\n追加效果 : 追加傷害 600%,\n以冰風車 冰結的 對敵人 1680% 追加傷害\n冷卻時間 10秒",
                    "7": "閃電重擊: 雷神\n\n閃電重擊 傷害倍率 1000% 增加\n可攻擊距離 12m\n閃電重擊 指定的敵人 7次攻擊\n閃電重擊 使用時 4秒 持續 [雷神] 狀態獲得\n[雷神] 狀態下 重擊 使用時 重擊 傷害倍率 300% 增加, [雷神] 狀態 종료\n\n元素注入 使用中時 追加效果發動\n追加效果 : 追加傷害 600%,\n以冰風車 冰結的 對敵人 1680% 追加傷害\n冷卻時間 10秒",
                    "8": "閃電重擊: 雷神\n\n閃電重擊 傷害倍率 1300% 增加\n可攻擊距離 12m\n閃電重擊 指定的敵人 7次攻擊\n閃電重擊 使用時 4秒 持續 [雷神] 狀態獲得\n[雷神] 狀態下 重擊 使用時 重擊 傷害倍率 350% 增加, [雷神] 狀態 종료\n\n元素注入 使用中時 追加效果發動\n追加效果 : 追加傷害 600%,\n以冰風車 冰結的 對敵人 1680% 追加傷害\n冷卻時間 10秒",
                    "9": "閃電重擊: 雷神\n\n閃電重擊 傷害倍率 1600% 增加\n可攻擊距離 12m\n閃電重擊 指定的敵人 7次攻擊\n閃電重擊 使用時 4秒 持續 [雷神] 狀態獲得\n[雷神] 狀態下 重擊 使用時 重擊 傷害倍率 500% 增加, [雷神] 狀態 종료\n\n元素注入 使用中時 追加效果發動\n追加效果 : 追加傷害 600%,\n以冰風車 冰結的 對敵人 1680% 追加傷害\n冷卻時間 10秒"
                }
            },
            {
                "id": 2,
                ...
                "points": {
                    "5": "火葉攻擊: 完全燃燒\n\n使用者的倒地攻擊 傷害 + 技能 傷害 攻擊\n可攻擊距離 : 使用者的倒地攻擊 距離 +1.2m\n火葉攻擊 攻擊 半徑 +1.5m\n\n[燃燒], [完全燃燒] 狀態 全部 없을 時 火葉攻擊 使用時 [燃燒] 狀態獲得\n\n[燃燒] 狀態下 근접 前투 재능/魔法 재능/火葉攻擊 제외한 엘레멘탈 나이트 技能 攻擊 時, [完全燃燒] 狀態 最大 5層直到 獲得\n\n[完全燃燒] 層 보유 中 火葉攻擊 使用時 火葉攻擊으로 目前 打擊한 敵人的數큼 最大 5層直到 追加 변환並, 最大 層일 情況 [燃燒]的持續時間 5秒 연장\n[燃燒]的持續時間 20秒 秒할 數 없음\n[完全燃燒] 層 每 100%的追加傷害 倍率\n\n元素注入 使用中時 追加效果發動\n追加效果 : 追加傷害 800%, 攻擊 目標 5秒 移動速度 20%, 攻擊 速度 20% 減少, 受擊的 敵人 타겟 위치로 끌어每김\n\n冷卻時間 1秒 減少",
                    "6": "火葉攻擊: 完全燃燒\n\n使用者的倒地攻擊 傷害 + 技能 傷害 攻擊\n可攻擊距離 : 使用者的倒地攻擊 距離 +1.2m\n火葉攻擊 攻擊 半徑 +2m\n\n[燃燒], [完全燃燒] 狀態 全部 없을 時 火葉攻擊 使用時 [燃燒] 狀態獲得\n\n[燃燒] 狀態下 근접 前투 재능/魔法 재능/火葉攻擊 제외한 엘레멘탈 나이트 技能 攻擊 時, [完全燃燒] 狀態 最大 5層直到 獲得\n\n[完全燃燒] 層 보유 中 火葉攻擊 使用時 火葉攻擊으로 目前 打擊한 敵人的數큼 最大 5層直到 追加 변환並, 最大 層일 情況 [燃燒]的持續時間 5秒 연장\n[燃燒]的持續時間 20秒 秒할 數 없음\n[完全燃燒] 層 每 100%的追加傷害 倍率\n\n元素注入 使用中時 追加效果發動\n追加效果 : 追加傷害 800%, 攻擊 目標 5秒 移動速度 20%, 攻擊 速度 20% 減少, 受擊的 敵人 타겟 위치로 끌어每김\n\n冷卻時間 1秒 減少",
                    "7": "火葉攻擊: 完全燃燒\n\n使用者的倒地攻擊 傷害 + 技能 傷害 攻擊\n可攻擊距離 : 使用者的倒地攻擊 距離 +1.2m\n火葉攻擊 攻擊 半徑 +2.5m\n\n[燃燒], [完全燃燒] 狀態 全部 없을 時 火葉攻擊 使用時 [燃燒] 狀態獲得\n\n[燃燒] 狀態下 근접 前투 재능/魔法 재능/火葉攻擊 제외한 엘레멘탈 나이트 技能 攻擊 時, [完全燃燒] 狀態 最大 5層直到 獲得\n\n[完全燃燒] 層 보유 中 火葉攻擊 使用時 火葉攻擊으로 目前 打擊한 敵人的數큼 最大 5層直到 追加 변환並, 最大 層일 情況 [燃燒]的持續時間 5秒 연장\n[燃燒]的持續時間 20秒 秒할 數 없음\n[完全燃燒] 層 每 100%的追加傷害 倍率\n\n元素注入 使用中時 追加效果發動\n追加效果 : 追加傷害 800%, 攻擊 目標 5秒 移動速度 20%, 攻擊 速度 20% 減少, 受擊的 敵人 타겟 위치로 끌어每김\n\n冷卻時間 1秒 減少",
                    "8": "火葉攻擊: 完全燃燒\n\n使用者的倒地攻擊 傷害 + 技能 傷害 攻擊\n可攻擊距離 : 使用者的倒地攻擊 距離 +1.2m\n火葉攻擊 攻擊 半徑 +3m\n\n[燃燒], [完全燃燒] 狀態 全部 없을 時 火葉攻擊 使用時 [燃燒] 狀態獲得\n\n[燃燒] 狀態下 근접 前투 재능/魔法 재능/火葉攻擊 제외한 엘레멘탈 나이트 技能 攻擊 時, [完全燃燒] 狀態 最大 5層直到 獲得\n\n[完全燃燒] 層 보유 中 火葉攻擊 使用時 火葉攻擊으로 目前 打擊한 敵人的數큼 最大 5層直到 追加 변환並, 最大 層일 情況 [燃燒]的持續時間 5秒 연장\n[燃燒]的持續時間 20秒 秒할 數 없음\n[完全燃燒] 層 每 100%的追加傷害 倍率\n\n元素注入 使用中時 追加效果發動\n追加效果 : 追加傷害 800%, 攻擊 目標 5秒 移動速度 20%, 攻擊 速度 20% 減少, 受擊的 敵人 타겟 위치로 끌어每김\n\n冷卻時間 1秒 減少",
                    "9": "火葉攻擊: 完全燃燒\n\n使用者的倒地攻擊 傷害 + 技能 傷害 攻擊\n可攻擊距離 : 使用者的倒地攻擊 距離 +1.2m\n火葉攻擊 攻擊 半徑 +4m\n\n[燃燒], [完全燃燒] 狀態 全部 없을 時 火葉攻擊 使用時 [燃燒] 狀態獲得\n\n[燃燒] 狀態下 근접 前투 재능/魔法 재능/火葉攻擊 제외한 엘레멘탈 나이트 技能 攻擊 時, [完全燃燒] 狀態 最大 5層直到 獲得\n\n[完全燃燒] 層 보유 中 火葉攻擊 使用時 火葉攻擊으로 目前 打擊한 敵人的數큼 最大 5層直到 追加 변환並, 最大 層일 情況 [燃燒]的持續時間 5秒 연장\n[燃燒]的持續時間 20秒 秒할 數 없음\n[完全燃燒] 層 每 100%的追加傷害 倍率\n\n元素注入 使用中時 追加效果發動\n追加效果 : 追加傷害 800%, 攻擊 目標 5秒 移動速度 20%, 攻擊 速度 20% 減少, 受擊的 敵人 타겟 위치로 끌어每김\n\n冷卻時間 1秒 減少"
        ...
        "combos": [
            {
                ...
                "points": {
                    "5": "淨化的鼓動: 공명\n\n攻擊範圍 半徑 7m\n1秒每 範圍內 技能 傷害 攻擊\n1秒每 範圍內 아군 生命力, 마나, 스태미나 恢復\n領域 維持 中 時前者的治療 效果 增加\n\n範圍內 아군 硬直, 다운 면역, 傷害 減少율 10% 增加, \n10每秒 보스 몬스터 일부 傷害 관련 해로운 效果 1疊加 減少\n領域 소멸 時 維持 時 依比例 追加 魔法 傷害\n\n領域 維持 時 16秒\n領域 維持 中 技能 재使用時 강제 소멸\n冷卻時間 60秒",
                    "6": "淨化的鼓動: 공명\n\n攻擊範圍 半徑 7m\n1秒每 範圍內 技能 傷害 攻擊\n1秒每 範圍內 아군 生命力, 마나, 스태미나 恢復\n領域 維持 中 時前者的治療 效果 增加\n\n範圍內 아군 硬直, 다운 면역, 傷害 減少율 20% 增加, \n9每秒 보스 몬스터 일부 傷害 관련 해로운 效果 1疊加 減少\n領域 소멸 時 維持 時 依比例 追加 魔法 傷害\n\n領域 維持 時 17秒\n領域 維持 中 技能 재使用時 강제 소멸\n冷卻時間 60秒",
                    "7": "淨化的鼓動: 공명\n\n攻擊範圍 半徑 7m\n1秒每 範圍內 技能 傷害 攻擊\n1秒每 範圍內 아군 生命力, 마나, 스태미나 恢復\n領域 維持 中 時前者的治療 效果 增加\n\n範圍內 아군 硬直, 다운 면역, 傷害 減少율 30% 增加, \n8每秒 보스 몬스터 일부 傷害 관련 해로운 效果 1疊加 減少\n領域 소멸 時 維持 時 依比例 追加 魔法 傷害\n\n領域 維持 時 18秒\n領域 維持 中 技能 재使用時 강제 소멸\n冷卻時間 60秒",
                    "8": "淨化的鼓動: 공명\n\n攻擊範圍 半徑 7m\n1秒每 範圍內 技能 傷害 攻擊\n1秒每 範圍內 아군 生命力, 마나, 스태미나 恢復\n領域 維持 中 時前者的治療 效果 增加\n\n範圍內 아군 硬直, 다운 면역, 傷害 減少율 40% 增加, \n6每秒 보스 몬스터 일부 傷害 관련 해로운 效果 1疊加 減少\n領域 소멸 時 維持 時 依比例 追加 魔法 傷害\n\n領域 維持 時 19秒\n領域 維持 中 技能 재使用時 강제 소멸\n冷卻時間 60秒",
                    "9": "淨化的鼓動: 공명\n\n攻擊範圍 半徑 7m\n1秒每 範圍內 技能 傷害 攻擊\n1秒每 範圍內 아군 生命力, 마나, 스태미나 恢復\n領域 維持 中 時前者的治療 效果 增加\n\n範圍內 아군 硬直, 다운 면역, 傷害 減少율 50% 增加, \n5每秒 보스 몬스터 일부 傷害 관련 해로운 效果 1疊加 減少\n領域 소멸 時 維持 時 依比例 追加 魔法 傷害\n\n領域 維持 時 20秒\n領域 維持 中 技能 재使用時 강제 소멸\n冷卻時間 60秒"
                }
            },
            {
                "id": 5,
                ...
                "points": {
                    "5": "音波洗禮: 幅음\n\n最大 15m 距離 內的目標 다次攻擊\n音波洗禮 傷害倍率 100% 增加\n스플래時 傷害 傷害倍率 10%, 範圍 半徑 0.5m 增加\n技能 使用時 救贖的回音 冷卻時間 0.5秒 減少\n受擊的 對敵人 불협화음 效果 180秒 套用 (最大 5疊加)\n\n불협화음 1疊加 每\n방어, 魔法방어 {n} 減少\n보호, 魔法보호 {n} 減少\n(治療 及 隊伍治療 技能 恢復量(魔法 攻擊력 제외) 依比例 效果 增加)\n\n恢復 效果 及 생명的온기 賦予 效果 비啟用\n冷卻時間 1秒",
                    "6": "音波洗禮: 幅음\n\n最大 15m 距離 內的目標 다次攻擊\n音波洗禮 傷害倍率 120% 增加\n스플래時 傷害 傷害倍率 15%, 範圍 半徑 1m 增加\n技能 使用時 救贖的回音 冷卻時間 0.5秒 減少\n受擊的 對敵人 불협화음 效果 180秒 套用 (最大 5疊加)\n\n불협화음 1疊加 每\n방어, 魔法방어 {n} 減少\n보호, 魔法보호 {n} 減少\n(治療 及 隊伍治療 技能 恢復量(魔法 攻擊력 제외) 依比例 效果 增加)\n\n恢復 效果 及 생명的온기 賦予 效果 비啟用\n冷卻時間 1秒",
                    "7": "音波洗禮: 幅음\n\n最大 15m 距離 內的目標 다次攻擊\n音波洗禮 傷害倍率 140% 增加\n스플래時 傷害 傷害倍率 20%, 範圍 半徑 1.5m 增加\n技能 使用時 救贖的回音 冷卻時間 1秒 減少\n受擊的 對敵人 불협화음 效果 180秒 套用 (最大 5疊加)\n\n불협화음 1疊加 每\n방어, 魔法방어 {n} 減少\n보호, 魔法보호 {n} 減少\n(治療 及 隊伍治療 技能 恢復量(魔法 攻擊력 제외) 依比例 效果 增加)\n\n恢復 效果 及 생명的온기 賦予 效果 비啟用\n冷卻時間 1秒",
                    "8": "音波洗禮: 幅음\n\n最大 15m 距離 內的目標 다次攻擊\n音波洗禮 傷害倍率 170% 增加\n스플래時 傷害 傷害倍率 25%, 範圍 半徑 2m 增加\n技能 使用時 救贖的回音 冷卻時間 1.5秒 減少\n受擊的 對敵人 불협화음 效果 180秒 套用 (最大 5疊加)\n\n불협화음 1疊加 每\n방어, 魔法방어 {n} 減少\n보호, 魔法보호 {n} 減少\n(治療 及 隊伍治療 技能 恢復量(魔法 攻擊력 제외) 依比例 效果 增加)\n\n恢復 效果 及 생명的온기 賦予 效果 비啟用\n冷卻時間 1秒",
                    "9": "音波洗禮: 幅음\n\n最大 15m 距離 內的目標 다次攻擊\n音波洗禮 傷害倍率 200% 增加\n스플래時 傷害 傷害倍率 30%, 範圍 半徑 2.5m 增加\n技能 使用時 救贖的回音 冷卻時間 2秒 減少\n受擊的 對敵人 불협화음 效果 180秒 套用 (最大 5疊加)\n\n불협화음 1疊加 每\n방어, 魔法방어 {n} 減少\n보호, 魔法보호 {n} 減少\n(治療 及 隊伍治療 技能 恢復量(魔法 攻擊력 제외) 依比例 效果 增加)\n\n恢復 效果 及 생명的온기 賦予 效果 비啟用\n冷卻時間 1秒"
                }
            },
            {
                "id": 6,
    ...
    },
    {
        ...
        "combos": [
            ...
            },
            {
                ...
                "points": {
                    "5": "水流貫穿: 激流\n\n水流貫穿 차징 無法\n使用者的麥格農射擊 傷害 + 原有 水流貫穿 最大 傷害倍率的7% 攻擊\n\n[흐름], [激流] 狀態 全部 보유하고 있지 않을 時 水流貫穿 使用時 [흐름] 獲得\n\n[흐름] 狀態下 麥格農射擊 使用時 [激流] 狀態 最大 3層直到 獲得\n\n[激流] 層 보유 中 水流貫穿 使用時 層 全部 消耗並, 層 每 2次的追加 攻擊 發生\n\n冷卻時間 10秒",
        ...
        "combos": [
            {
                ...
                "points": {
                    "5": "光輝的斷罪: 집행\n\n光輝的斷罪 상時 3단계로 동작\n光輝的斷罪的基本 傷害, 방어력, 最大 生命力 倍率 1.1배 增加\n\n敵人 혹은 지정한 곳으로 使用 可\n技能 移動 可 距離 : 最大 6m\n\n高潔的 誓約 啟用 狀態일 情況 犧牲 4 獲得\n\n冷卻時間 2.5秒",
                    "6": "光輝的斷罪: 집행\n\n光輝的斷罪 상時 3단계로 동작\n光輝的斷罪的基本 傷害, 방어력, 最大 生命力 倍率 1.2배 增加\n攻擊範圍 半徑 增加\n\n敵人 혹은 지정한 곳으로 使用 可\n技能 移動 可 距離 : 最大 6.5m\n\n高潔的 誓約 啟用 狀態일 情況 犧牲 4 獲得\n\n冷卻時間 2.5秒",
                    "7": "光輝的斷罪: 집행\n\n光輝的斷罪 상時 3단계로 동작\n光輝的斷罪的基本 傷害, 방어력, 最大 生命力 倍率 1.3배 增加\n攻擊範圍 半徑 增加\n\n敵人 혹은 지정한 곳으로 使用 可\n技能 移動 可 距離 : 最大 7m\n\n高潔的 誓約 啟用 狀態일 情況 犧牲 4 獲得\n\n冷卻時間 2.5秒",
                    "8": "光輝的斷罪: 집행\n\n光輝的斷罪 상時 3단계로 동작\n光輝的斷罪的基本 傷害, 방어력, 最大 生命力 倍率 1.4배 增加\n攻擊範圍 半徑 增加\n\n敵人 혹은 지정한 곳으로 使用 可\n技能 移動 可 距離 : 最大 7.5m\n\n高潔的 誓約 啟用 狀態일 情況 犧牲 4 獲得\n\n冷卻時間 2.5秒",
                    "9": "光輝的斷罪: 집행\n\n光輝的斷罪 상時 3단계로 동작\n光輝的斷罪的基本 傷害, 방어력, 最大 生命力 倍率 1.5배 增加\n攻擊範圍 半徑 增加\n\n敵人 혹은 지정한 곳으로 使用 可\n技能 移動 可 距離 : 最大 8m\n\n高潔的 誓約 啟用 狀態일 情況 犧牲 4 獲得\n\n冷卻時間 2.5秒"
                }
            },
            {
                "id": 14,
        ...
        "combos": [
            {
                ...
                "points": {
                    "5": "重型火砲: 연속 포격\n\n半徑 9m的領域 基本 傷害的600% +\n十字爆破 傷害 攻擊\n魔力彈 10 消耗\n煉成 能量 200 增加\n(煉成 能量탄 1個: 煉成 能量 100)\n\n煉成領域 존재할 時\n技能 使用 後 6秒每 最大 3次直到 追加 포격 發生\n\n冷卻時間 15秒 增加",
                    "6": "重型火砲: 연속 포격\n\n半徑 9m的領域 基本 傷害的600% +\n十字爆破 傷害 攻擊\n魔力彈 10 消耗\n煉成 能量 200 增加\n(煉成 能量탄 1個: 煉成 能量 100)\n\n煉成領域 존재할 時\n技能 使用 後 5.5秒每 最大 3次直到 追加 포격 發生\n\n冷卻時間 15秒 增加",
                    "7": "重型火砲: 연속 포격\n\n半徑 9m的領域 基本 傷害的600% +\n十字爆破 傷害 攻擊\n魔力彈 10 消耗\n煉成 能量 200 增加\n(煉成 能量탄 1個: 煉成 能量 100)\n\n煉成領域 존재할 時\n技能 使用 後 5秒每 最大 4次直到 追加 포격 發生\n\n冷卻時間 15秒 增加",
                    "8": "重型火砲: 연속 포격\n\n半徑 9m的領域 基本 傷害的600% +\n十字爆破 傷害 攻擊\n魔力彈 10 消耗\n煉成 能量 200 增加\n(煉成 能量탄 1個: 煉成 能量 100)\n\n煉成領域 존재할 時\n技能 使用 後 4.5秒每 最大 4次直到 追加 포격 發生\n\n冷卻時間 15秒 增加",
                    "9": "重型火砲: 연속 포격\n\n半徑 9m的領域 基本 傷害的600% +\n十字爆破 傷害 攻擊\n魔力彈 10 消耗\n煉成 能量 200 增加\n(煉成 能量탄 1個: 煉成 能量 100)\n\n煉成領域 존재할 時\n技能 使用 後 4秒每 最大 5次直到 追加 포격 發生\n\n冷卻時間 15秒 增加"
                }
            },
            {
                "id": 20,
    ...
    },
    {
        ...
        "combos": [
            {
                ...
                "points": {
                    "5": "螺旋噴發: 응축\n\n螺旋噴發的누敵人 冷卻時間 依照 可 最大 充能 횟數큼 한 번에 充能以,\n半徑 3m 範圍內的敵人 目標들을 中심으로 每기고 攻擊\n\n1充能 傷害: 原有 傷害的100%,\n1充能 追加 時每 38%큼 傷害 增加\n充能 횟數 依比例 홀딩 時 0.5秒씩 增加\n\n技能 使用時, 4屬性 鍊金術 能量 恢復\n(엘레멘탈 콤비네이션 조합식的결정 消耗量 依照 能量 恢復量 增加)\n充能 횟數 依比例 能量 恢復量 增加",
                    "6": "螺旋噴發: 응축\n\n螺旋噴發的누敵人 冷卻時間 依照 可 最大 充能 횟數큼 한 번에 充能以,\n半徑 3m 範圍內的敵人 目標들을 中심으로 每기고 攻擊\n\n1充能 傷害: 原有 傷害的105%,\n1充能 追加 時每 41%큼 傷害 增加\n充能 횟數 依比例 홀딩 時 0.5秒씩 增加\n\n技能 使用時, 4屬性 鍊金術 能量 恢復\n(엘레멘탈 콤비네이션 조합식的결정 消耗量 依照 能量 恢復量 增加)\n充能 횟數 依比例 能量 恢復量 增加",
                    "7": "螺旋噴發: 응축\n\n螺旋噴發的누敵人 冷卻時間 依照 可 最大 充能 횟數큼 한 번에 充能以,\n半徑 3m 範圍內的敵人 目標들을 中심으로 每기고 攻擊\n\n1充能 傷害: 原有 傷害的110%,\n1充能 追加 時每 44%큼 傷害 增加\n充能 횟數 依比例 홀딩 時 0.5秒씩 增加\n\n技能 使用時, 4屬性 鍊金術 能量 恢復\n(엘레멘탈 콤비네이션 조합식的결정 消耗量 依照 能量 恢復量 增加)\n充能 횟數 依比例 能量 恢復量 增加",
                    "8": "螺旋噴發: 응축\n\n螺旋噴發的누敵人 冷卻時間 依照 可 最大 充能 횟數큼 한 번에 充能以,\n半徑 3m 範圍內的敵人 目標들을 中심으로 每기고 攻擊\n\n1充能 傷害: 原有 傷害的115%,\n1充能 追加 時每 47%큼 傷害 增加\n充能 횟數 依比例 홀딩 時 0.5秒씩 增加\n\n技能 使用時, 4屬性 鍊金術 能量 恢復\n(엘레멘탈 콤비네이션 조합식的결정 消耗量 依照 能量 恢復量 增加)\n充能 횟數 依比例 能量 恢復量 增加",
                    "9": "螺旋噴發: 응축\n\n螺旋噴發的누敵人 冷卻時間 依照 可 最大 充能 횟數큼 한 번에 充能以,한\n最大 充能 횟數큼 한 번에 充能以,\n半徑 3m 範圍內的敵人 目標들을 中심으로 每기고 攻擊\n\n1充能 傷害: 原有 傷害的120%,\n1充能 追加 時每 50%큼 傷害 增加\n充能 횟數 依比例 홀딩 時 0.5秒씩 增加\n\n技能 使用時, 4屬性 鍊金術 能量 恢復\n(엘레멘탈 콤비네이션 조합식的결정 消耗量 依照 能量 恢復量 增加)\n充能 횟數 依比例 能量 恢復量 增加"
                }
            },
            {
                "id": 23,
        ...
        "effectTable": [
            {
                "category": "祕法",
                "option": "召喚夢魘 (흙 鍊金術 效果) 技能 最終 傷害倍率增加",
                "base": "0.2",
                "special": true,
                "skillName": "召喚夢魘",
            ...
            {
                "category": "祕法",
                "option": "化學嘉年華 (불 鍊金術 效果) 주 목표에게 주는 最終 傷害倍率增加",
                "base": "0.2",
                "special": true,
                "skillName": "化學嘉年華",
                "skillIcon": "https://tacask-cdn.com/mabi-labanyu/web-upload/img-1762278947694.webp"
            ...
            {
                "category": "祕法",
                "option": "螺旋噴發 (물 鍊金術 效果) 技能 技能 最終 傷害倍率增加",
                "base": "1",
                "special": true,
                "skillName": "螺旋噴發",
                "skillIcon": "https://tacask-cdn.com/mabi-labanyu/web-upload/img-1762278967471.webp"
            ...
            {
                "category": "屬性",
                "option": "불 屬性 鍊金術 傷害 增加",
                "base": "10"
            },
            {
                "category": "屬性",
                "option": "물 屬性 鍊金術 傷害 增加",
                "base": "10"
            },
            {
                "category": "屬性",
                "option": "바람 屬性 鍊金術 傷害 增加",
                "base": "10"
            },
            {
                "category": "屬性",
                "option": "흙 屬性 鍊金術 傷害 增加",
                "base": "10"
            }
        ]
    },
        ...
        "combos": [
            {
                ...
                "points": {
                    "5": "間奏斬擊: 크레센도\n\n人偶 召喚 技能 攻擊 時 對敵人 最大 3次直到 쌓이는 層형 '크레센도' 狀態 賦予\n\n層 쌓인 敵人 層 數 비례한 傷害 攻擊\n(人偶 1기 以上 召喚되었을 時 技能 使用 可)\n1層 傷害: 原有 間奏斬擊 傷害倍率 +5%\n層 5秒 維持되며, 維持 時 종료 時 層 秒氣化\n冷卻時間 4秒",
            ...
            },
            {
                ...
                "points": {
                    "5": "強拍重音: 앙상블\n\n召喚 可 人偶 全部 召喚\n\n人偶 3기 召喚 時, 각 人偶 幅 5m, 길이 10m 範圍 세 방향 突進並 2次攻擊\n強拍重音的最終 傷害 최秒 攻擊,\n최秒 攻擊的60% 追加 攻擊\n\n人偶 2기 召喚 時, 人偶 2기가 幅 7.5m, 길이 10m 範圍 앞으로 突進並 2次攻擊\n強拍重音的最終 傷害 최秒 攻擊,\n최秒 攻擊的70% 追加 攻擊\n\n人偶 1기 召喚 時, 人偶 1기가 半徑 2.5m 內 對敵人\n突進並 強拍重音的最終 傷害的80% 3次攻擊\n\n冷卻時間 8秒",
        ...
        "combos": [
            {
                ...
                "points": {
                    "5": "疾風穿刺: 突進\n\n疾風穿刺 使用時 타겟한 敵人 방향으로 5m 突進 後, 原有 疾風穿刺 傷害的100% 攻擊\n\n疾風穿刺 使用 後 5秒 內 연속기 3단계 技能 使用時, 原有 傷害的104% 敵人 攻擊\n\n포스 消耗量 1個\n\n自身게 퓨리어스 앱솔루트를 10秒 期間 套用\n(일정 數준 이하的헤비 스텐더 者동 방어를 무時하고, 너클 무기를 使用以 攻擊 가하는 技能的피해量 15% 增加 效果 賦予 (레이지 임팩트 效果 疊加 無法))",
                    "6": "疾風穿刺: 突進\n\n疾風穿刺 使用時 타겟한 敵人 방향으로 5m 突進 後, 原有 疾風穿刺 傷害的105% 攻擊\n\n疾風穿刺 使用 後 5秒 內 연속기 3단계 技能 使用時, 原有 傷害的106% 敵人 攻擊\n\n포스 消耗量 1個\n\n自身게 퓨리어스 앱솔루트를 10秒 期間 套用\n(일정 數준 이하的헤비 스텐더 者동 방어를 무時하고, 너클 무기를 使用以 攻擊 가하는 技能的피해量 15% 增加 效果 賦予 (레이지 임팩트 效果 疊加 無法))",
                    "7": "疾風穿刺: 突進\n\n疾風穿刺 使用時 타겟한 敵人 방향으로 5m 突進 後, 原有 疾風穿刺 傷害的110% 攻擊\n\n疾風穿刺 使用 後 5秒 內 연속기 3단계 技能 使用時, 原有 傷害的108% 敵人 攻擊\n\n포스 消耗量 1個\n\n自身게 퓨리어스 앱솔루트를 10秒 期間 套用\n(일정 數준 이하的헤비 스텐더 者동 방어를 무時하고, 너클 무기를 使用以 攻擊 가하는 技能的피해量 15% 增加 效果 賦予 (레이지 임팩트 效果 疊加 無法))",
                    "8": "疾風穿刺: 突進\n\n疾風穿刺 使用時 타겟한 敵人 방향으로 5m 突進 後, 原有 疾風穿刺 傷害的115% 攻擊\n\n疾風穿刺 使用 後 5秒 內 연속기 3단계 技能 使用時, 原有 傷害的110% 敵人 攻擊\n\n포스 消耗量 1個\n\n自身게 퓨리어스 앱솔루트를 10秒 期間 套用\n(일정 數준 이하的헤비 스텐더 者동 방어를 무時하고, 너클 무기를 使用以 攻擊 가하는 技能的피해量 15% 增加 效果 賦予 (레이지 임팩트 效果 疊加 無法))",
                    "9": "疾風穿刺: 突進\n\n疾風穿刺 使用時 타겟한 敵人 방향으로 5m 突進 後, 原有 疾風穿刺 傷害的120% 攻擊\n\n疾風穿刺 使用 後 5秒 內 연속기 3단계 技能 使用時, 原有 傷害的112% 敵人 攻擊\n\n포스 消耗量 1個\n\n自身게 퓨리어스 앱솔루트를 10秒 期間 套用\n(일정 數준 이하的헤비 스텐더 者동 방어를 무時하고, 너클 무기를 使用以 攻擊 가하는 技能的피해量 15% 增加 效果 賦予 (레이지 임팩트 效果 疊加 無法))"
                }
            },
            {
                "id": 29,
                ...
                "points": {
                    "5": "終極一擊: 극的\n\n原有 1,2타 攻擊 傷害的120% 2次攻擊\n原有 終結 攻擊 傷害的150% 終結 攻擊\n\n포스 消耗量 3個\n冷卻時間 45秒\n\n自身게 퓨리어스 앱솔루트를 10秒 期間 套用\n(일정 數준 이하的헤비 스텐더 者동 방어를 무時하고,\n너클 무기를 使用以 攻擊 가하는 技能的피해量\n15% 增加 效果 賦予 (레이지 임팩트 效果 疊加 無法))",
